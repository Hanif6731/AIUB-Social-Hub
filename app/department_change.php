...
<?php
	if(isset($_POST['change_department']))
	{
        ...
        $query="update profile set department='$department' where username='$user_name';";
...
?>
    ...
    <body>
        ...
        <form method="post"  name="change_department"  onSubmit="return name_check();">
            <table align="right" width="80%">
                <tr>
                    ...
                    <td align="left">
                        ...
                        <input type="submit" value="Save" name="change_department" class="save_button"><br> <br>
