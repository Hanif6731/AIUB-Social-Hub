...
<?php
	if(isset($_POST['change_hometown']))
	{
        $hometown = $_POST['hometown'];
        
        $query="update profile set hometown='$hometown' where username='$user_name';";
            ...
            <table align="right" width="80%">
                <tr>
                    ...
                    <td align="left">
                        ...
                        <input type="submit" value="Save" name="change_hometown" class="save_button"><br> <br>
